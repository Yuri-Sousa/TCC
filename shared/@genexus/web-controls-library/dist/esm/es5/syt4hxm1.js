...
function NavBarLinkRender(e) {
  ...
  return function(e) {
    ...
    return __extends(class_1, e), class_1.prototype.handleClick = function(e) {
      ...
      var e;
      return this.element.classList.add("nav-item"), h("a", {
        class: (e = {
          active: this.active,
...
var NavBarLink = /** @class */ function(e) {
  function NavBarLink() {
...
}(NavBarLinkRender(BaseComponent));

export { NavBarLink as GxNavbarLink };