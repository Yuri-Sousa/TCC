...
/*! Built with http://stenciljs.com */ GxWebControls.loadBundle("cdyrrqr2", [ "exports", "./chunk-440ea385.js" ], function(e, t) {
  var n = window.GxWebControls.h, o = 0, i = /** @class */ function(e) {
    function Select() {
    ...
    return __extends(class_1, e), class_1.prototype.getNativeInputId = function() {
      ...
      var e = this;
      if (this.selectId || (this.selectId = this.id ? this.id + "__select" : "gx-select-auto-id-" + o++), 
      this.readonly) return n("span", {
      ...
      return n("select", Object.assign({}, t), this.options.map(function(e) {
        var t = e.disabled, o = e.innerText, i = e.selected, s = e.value;
        return n("option", {
          disabled: t,
          selected: i,
          value: s
  ...
  e.GxSelect = i, Object.defineProperty(e, "__esModule", {
    value: !0
  });
});