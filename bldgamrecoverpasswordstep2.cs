...
using System.IO;
public class bldgamrecoverpasswordstep2 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldgamrecoverpasswordstep2( ) : base()
   {
   }
   ...
   {
      bldgamrecoverpasswordstep2 x = new bldgamrecoverpasswordstep2() ;
      x.SetMainSourceFile( "gamrecoverpasswordstep2.cs");
