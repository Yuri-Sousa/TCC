...
using System.IO;
public class bldasecgamupdatepermissions : GxBaseBuilder
{
   string cs_path = "." ;
   public bldasecgamupdatepermissions( ) : base()
   {
   }
   ...
   public override int AfterCompile( )
   {
      ...
      if ( ! File.Exists(@"bin\ASECGAMUPDATEPERMISSIONS.exe.config") || checkTime(@"bin\ASECGAMUPDATEPERMISSIONS.exe.config",cs_path + @"\ASECGAMUPDATEPERMISSIONS.exe.config") )
      {
         File.Copy( cs_path + @"\ASECGAMUPDATEPERMISSIONS.exe.config", @"bin\ASECGAMUPDATEPERMISSIONS.exe.config", true);
      }
   ...
   {
      bldasecgamupdatepermissions x = new bldasecgamupdatepermissions() ;
      x.SetMainSourceFile( "asecgamupdatepermissions.cs");
