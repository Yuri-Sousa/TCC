   ...
   public class gamconnectionentry : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB170( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavConnectionname_Internalname, "Nome da conexão", " AttributeLabel", 1, true, "");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUserpassword_Internalname, "Senha do usuário", " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
      ...
      protected void START172( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Conexão", 0) ;
         }
         context.wjLoc = "";
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_gamconnection_Title = "Conteúdo do connection.gam";
         ...
         Dvpanel_tableattributes_Title = "Conexão";
