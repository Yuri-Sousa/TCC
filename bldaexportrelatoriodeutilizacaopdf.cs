...
using System.IO;
public class bldaexportrelatoriodeutilizacaopdf : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaexportrelatoriodeutilizacaopdf( ) : base()
   {
   }
   ...
   {
      bldaexportrelatoriodeutilizacaopdf x = new bldaexportrelatoriodeutilizacaopdf() ;
      x.SetMainSourceFile( "aexportrelatoriodeutilizacaopdf.cs");
