...
using System.IO;
public class bldaexportrelatoriodehorastrabalhadaspdf : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaexportrelatoriodehorastrabalhadaspdf( ) : base()
   {
   }
   ...
   {
      bldaexportrelatoriodehorastrabalhadaspdf x = new bldaexportrelatoriodehorastrabalhadaspdf() ;
      x.SetMainSourceFile( "aexportrelatoriodehorastrabalhadaspdf.cs");
