...
namespace GeneXus.Programs {
   public class gamssologin : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20214281551443", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbback_Internalname, "Retorno", "", "", lblTbback_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, 0, "HLP_GAMSSOLogin.htm");
      ...
      protected void E110G2( )
      {
         ...
         {
            AV8isOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnection(((GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo)AV5ConnectionInfoCollection.Item(1)).gxTpr_Name, out  AV7Errors);
         }
         AV9isRedirect = false;
         AV7Errors = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
         if ( ( AV7Errors.Count > 0 ) && ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV7Errors.Item(1)).gxTpr_Code != 104 ) )
         {
         ...
         {
            AV11SessionValid = new GeneXus.Programs.genexussecurity.SdtGAMSession(context).isvalid(out  AV10Session, out  AV7Errors);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202142815511214", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("gamssologin.js", "?202142815511219", false, true);
         }
