...
using System.IO;
public class bldasalvarultimodadolidodistribui : GxBaseBuilder
{
   string cs_path = "." ;
   public bldasalvarultimodadolidodistribui( ) : base()
   {
   }
   ...
   {
      bldasalvarultimodadolidodistribui x = new bldasalvarultimodadolidodistribui() ;
      x.SetMainSourceFile( "asalvarultimodadolidodistribui.cs");
