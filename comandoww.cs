...
namespace GeneXus.Programs {
   public class comandoww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public comandoww( )
      {
      ...
      public comandoww( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202142815565698", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("comandoww.aspx") +"\">") ;
      ...
      {
         return formatLink("comandoww.aspx")  ;
      }
      ...
      protected void WB2V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ComandoWW.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "Seleciona colunas", bttBtneditcolumns_Jsonclick, 0, "Seleciona colunas", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_ComandoWW.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Assinaturas", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_ComandoWW.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void wb_table1_25_2V2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((edtComandoId_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Sequência") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((edtComandoNome_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Nome") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((cmbComandoFabricanteModulo.Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Fabricante") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((cmbComandoModeloModulo.Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A137ComandoId), 8, 0, ".", "")));
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtComandoId_Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A138ComandoNome);
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtComandoNome_Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A140ComandoFabricanteModulo);
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(cmbComandoFabricanteModulo.Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A141ComandoModeloModulo);
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(cmbComandoModeloModulo.Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VGRIDACTIONS.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VGRIDACTIONS.CLICK") == 0 ) )
                           {
                              ...
                              cmbComandoFabricanteModulo.Name = cmbComandoFabricanteModulo_Internalname;
                              ...
                              cmbComandoModeloModulo.Name = cmbComandoModeloModulo_Internalname;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_COMANDOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A137ComandoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "COMANDOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A137ComandoId), 8, 0, ".", "")));
      }
      ...
      protected void RF2V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV37Comandowwds_1_filterfulltext ,
                                                 A137ComandoId ,
                                                 A138ComandoNome ,
            ...
            lV37Comandowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV37Comandowwds_1_filterfulltext), "%", "");
            lV37Comandowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV37Comandowwds_1_filterfulltext), "%", "");
            lV37Comandowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV37Comandowwds_1_filterfulltext), "%", "");
            lV37Comandowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV37Comandowwds_1_filterfulltext), "%", "");
            lV37Comandowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV37Comandowwds_1_filterfulltext), "%", "");
            lV37Comandowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV37Comandowwds_1_filterfulltext), "%", "");
            /* Using cursor H002V2 */
            pr_default.execute(0, new Object[] {lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_43_idx = 1;
            sGXsfl_43_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_43_idx), 4, 0), 4, "0");
            SubsflControlProps_432( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A141ComandoModeloModulo = H002V2_A141ComandoModeloModulo[0];
               A140ComandoFabricanteModulo = H002V2_A140ComandoFabricanteModulo[0];
               A138ComandoNome = H002V2_A138ComandoNome[0];
               A137ComandoId = H002V2_A137ComandoId[0];
               E192V2 ();
      ...
      protected void send_integrity_lvl_hashes2V2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DELETE", AV31IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( "", AV31IsAuthorized_Delete, context));
         GxWebStd.gx_hidden_field( context, "gxhash_COMANDOID"+"_"+sGXsfl_43_idx, GetSecureSignedToken( sGXsfl_43_idx, context.localUtil.Format( (decimal)(A137ComandoId), "ZZZZZZZ9"), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV32IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV32IsAuthorized_Insert, context));
      }
      ...
      {
         AV37Comandowwds_1_filterfulltext = AV16FilterFullText;
         ...
         lV37Comandowwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV37Comandowwds_1_filterfulltext), "%", "");
         /* Using cursor H002V3 */
         pr_default.execute(1, new Object[] {lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext, lV37Comandowwds_1_filterfulltext});
      ...
      protected void E182V2( )
      {
         ...
         if ( StringUtil.StrCmp(AV21Session.Get("ComandoWWColumnsSelector"), "") != 0 )
         {
            AV17ColumnsSelectorXML = AV21Session.Get("ComandoWWColumnsSelector");
         ...
         edtComandoId_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtComandoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtComandoId_Visible), 5, 0), !bGXsfl_43_Refreshing);
         edtComandoNome_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtComandoNome_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtComandoNome_Visible), 5, 0), !bGXsfl_43_Refreshing);
         cmbComandoFabricanteModulo.Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, cmbComandoFabricanteModulo_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(cmbComandoFabricanteModulo.Visible), 5, 0), !bGXsfl_43_Refreshing);
         cmbComandoModeloModulo.Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV19ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, cmbComandoModeloModulo_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(cmbComandoModeloModulo.Visible), 5, 0), !bGXsfl_43_Refreshing);
      ...
      protected void E152V2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "ComandoWWColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV17ColumnsSelectorXML)) ? "" : AV19ColumnsSelector.ToXml(false, true, "WWPColumnsSelector", "RastreamentoTCC"))) ;
      ...
      protected void E112V2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("ComandoWWFilters")),UrlEncode(StringUtil.RTrim(AV36Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV24ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV24ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV24ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("ComandoWWFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV24ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV24ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV24ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "ComandoWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void E162V2( )
      {
         ...
         {
            CallWebObject(formatLink("comando.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","ComandoId"}) );
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "ComandoId",  "",  "Sequência",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "ComandoNome",  "",  "Nome",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "ComandoFabricanteModulo",  "",  "Fabricante",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV19ColumnsSelector,  "ComandoModeloModulo",  "",  "Modelo",  true,  "") ;
         GXt_char2 = AV18UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "ComandoWWColumnsSelector", out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "comando_Update", out  GXt_boolean3) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "comando_Delete", out  GXt_boolean3) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "comando_Insert", out  GXt_boolean3) ;
         ...
         if ( ! ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Comando",  1) ) )
         {
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "ComandoWWFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S202( )
      {
         ...
         if ( AV30IsAuthorized_Update )
         {
            CallWebObject(formatLink("comando.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A137ComandoId,8,0))}, new string[] {"Mode","ComandoId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S212( )
      {
         ...
         if ( AV31IsAuthorized_Delete )
         {
            CallWebObject(formatLink("comando.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A137ComandoId,8,0))}, new string[] {"Mode","ComandoId"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S122( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Comando";
      ...
      protected void wb_table1_25_2V2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_30_2V2( true) ;
         }
         else
         {
            wb_table2_30_2V2( false) ;
         }
         return  ;
      }

      protected void wb_table2_30_2V2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_30_2V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202142815565933", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("comandoww.js", "?202142815565934", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_432( )
      {
         ...
         edtComandoId_Internalname = "COMANDOID_"+sGXsfl_43_idx;
         edtComandoNome_Internalname = "COMANDONOME_"+sGXsfl_43_idx;
         cmbComandoFabricanteModulo_Internalname = "COMANDOFABRICANTEMODULO_"+sGXsfl_43_idx;
         cmbComandoModeloModulo_Internalname = "COMANDOMODELOMODULO_"+sGXsfl_43_idx;
      }

      protected void SubsflControlProps_fel_432( )
      {
         cmbavGridactions_Internalname = "vGRIDACTIONS_"+sGXsfl_43_fel_idx;
         edtComandoId_Internalname = "COMANDOID_"+sGXsfl_43_fel_idx;
         edtComandoNome_Internalname = "COMANDONOME_"+sGXsfl_43_fel_idx;
         cmbComandoFabricanteModulo_Internalname = "COMANDOFABRICANTEMODULO_"+sGXsfl_43_fel_idx;
         cmbComandoModeloModulo_Internalname = "COMANDOMODELOMODULO_"+sGXsfl_43_fel_idx;
      }
      ...
      protected void sendrow_432( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_43_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+((edtComandoId_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtComandoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A137ComandoId), 8, 0, ",", "")),context.localUtil.Format( (decimal)(A137ComandoId), "ZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtComandoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(int)edtComandoId_Visible,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)43,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((edtComandoNome_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtComandoNome_Internalname,(string)A138ComandoNome,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtComandoNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(int)edtComandoNome_Visible,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)60,(short)0,(short)0,(short)43,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((cmbComandoFabricanteModulo.Visible==0) ? "display:none;" : "")+"\">") ;
            }
            if ( ( cmbComandoFabricanteModulo.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "COMANDOFABRICANTEMODULO_" + sGXsfl_43_idx;
               cmbComandoFabricanteModulo.Name = GXCCtl;
            ...
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbComandoFabricanteModulo,(string)cmbComandoFabricanteModulo_Internalname,StringUtil.RTrim( A140ComandoFabricanteModulo),(short)1,(string)cmbComandoFabricanteModulo_Jsonclick,(short)0,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"svchar",(string)"",cmbComandoFabricanteModulo.Visible,(short)0,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn hidden-xs",(string)"",(string)"",(string)"",(bool)true});
            cmbComandoFabricanteModulo.CurrentValue = StringUtil.RTrim( A140ComandoFabricanteModulo);
            AssignProp("", false, cmbComandoFabricanteModulo_Internalname, "Values", (string)(cmbComandoFabricanteModulo.ToJavascriptSource()), !bGXsfl_43_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((cmbComandoModeloModulo.Visible==0) ? "display:none;" : "")+"\">") ;
            }
            if ( ( cmbComandoModeloModulo.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "COMANDOMODELOMODULO_" + sGXsfl_43_idx;
               cmbComandoModeloModulo.Name = GXCCtl;
            ...
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbComandoModeloModulo,(string)cmbComandoModeloModulo_Internalname,StringUtil.RTrim( A141ComandoModeloModulo),(short)1,(string)cmbComandoModeloModulo_Jsonclick,(short)0,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"svchar",(string)"",cmbComandoModeloModulo.Visible,(short)0,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn hidden-xs",(string)"",(string)"",(string)"",(bool)true});
            cmbComandoModeloModulo.CurrentValue = StringUtil.RTrim( A141ComandoModeloModulo);
            AssignProp("", false, cmbComandoModeloModulo_Internalname, "Values", (string)(cmbComandoModeloModulo.ToJavascriptSource()), !bGXsfl_43_Refreshing);
      ...
      public override void initialize_properties( )
      {
         ...
         subGrid_Sortable = 0;
         subGrid_Header = "";
         cmbComandoModeloModulo.Visible = -1;
         cmbComandoFabricanteModulo.Visible = -1;
         edtComandoNome_Visible = -1;
         edtComandoId_Visible = -1;
         cmbavGridactions_Class = "ConvertToDDO";
         ...
         Ddo_grid_Columnids = "1:ComandoId|2:ComandoNome|3:ComandoFabricanteModulo|4:ComandoModeloModulo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH",",oparms:[{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtComandoId_Visible',ctrl:'COMANDOID',prop:'Visible'},{av:'edtComandoNome_Visible',ctrl:'COMANDONOME',prop:'Visible'},{av:'cmbComandoFabricanteModulo'},{av:'cmbComandoModeloModulo'},{av:'AV27GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV28GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV33GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV31IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{ctrl:'BTNSUBSCRIPTIONS',prop:'Visible'},{av:'AV22ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E192V2',iparms:[{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV31IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'cmbavGridactions'},{av:'AV29GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'}]}");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'E152V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV36Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV31IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",",oparms:[{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'edtComandoId_Visible',ctrl:'COMANDOID',prop:'Visible'},{av:'edtComandoNome_Visible',ctrl:'COMANDONOME',prop:'Visible'},{av:'cmbComandoFabricanteModulo'},{av:'cmbComandoModeloModulo'},{av:'AV27GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV28GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV33GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV31IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{ctrl:'BTNSUBSCRIPTIONS',prop:'Visible'},{av:'AV22ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtComandoId_Visible',ctrl:'COMANDOID',prop:'Visible'},{av:'edtComandoNome_Visible',ctrl:'COMANDONOME',prop:'Visible'},{av:'cmbComandoFabricanteModulo'},{av:'cmbComandoModeloModulo'},{av:'AV27GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV28GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV33GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV31IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{ctrl:'BTNSUBSCRIPTIONS',prop:'Visible'},{av:'AV22ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
         setEventMetadata("VGRIDACTIONS.CLICK","{handler:'E202V2',iparms:[{av:'cmbavGridactions'},{av:'AV29GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV36Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV31IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A137ComandoId',fld:'COMANDOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("VGRIDACTIONS.CLICK",",oparms:[{av:'cmbavGridactions'},{av:'AV29GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtComandoId_Visible',ctrl:'COMANDOID',prop:'Visible'},{av:'edtComandoNome_Visible',ctrl:'COMANDONOME',prop:'Visible'},{av:'cmbComandoFabricanteModulo'},{av:'cmbComandoModeloModulo'},{av:'AV27GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV28GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV33GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV31IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{ctrl:'BTNSUBSCRIPTIONS',prop:'Visible'},{av:'AV22ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("'DOINSERT'","{handler:'E162V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV36Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV31IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A137ComandoId',fld:'COMANDOID',pic:'ZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtComandoId_Visible',ctrl:'COMANDOID',prop:'Visible'},{av:'edtComandoNome_Visible',ctrl:'COMANDONOME',prop:'Visible'},{av:'cmbComandoFabricanteModulo'},{av:'cmbComandoModeloModulo'},{av:'AV27GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV28GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV33GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV30IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV31IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{ctrl:'BTNSUBSCRIPTIONS',prop:'Visible'},{av:'AV22ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("NULL","{handler:'Valid_Comandomodelomodulo',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         lV37Comandowwds_1_filterfulltext = "";
         AV37Comandowwds_1_filterfulltext = "";
         H002V2_A141ComandoModeloModulo = new string[] {""} ;
         H002V2_A140ComandoFabricanteModulo = new string[] {""} ;
         H002V2_A138ComandoNome = new string[] {""} ;
         H002V2_A137ComandoId = new int[1] ;
         ...
         GXCCtl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.comandoww__default(),
            new Object[][] {
                new Object[] {
               H002V2_A141ComandoModeloModulo, H002V2_A140ComandoFabricanteModulo, H002V2_A138ComandoNome, H002V2_A137ComandoId
               }
               , new Object[] {
      ...
      private int edtComandoId_Visible ;
      private int edtComandoNome_Visible ;
      ...
      private string lV37Comandowwds_1_filterfulltext ;
      private string AV37Comandowwds_1_filterfulltext ;
      ...
      private string[] H002V2_A141ComandoModeloModulo ;
      private string[] H002V2_A140ComandoFabricanteModulo ;
      private string[] H002V2_A138ComandoNome ;
      private int[] H002V2_A137ComandoId ;
   ...
   public class comandoww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H002V2( IGxContext context ,
                                             string AV37Comandowwds_1_filterfulltext ,
                                             int A137ComandoId ,
                                             string A138ComandoNome ,
                                             string A140ComandoFabricanteModulo ,
                                             string A141ComandoModeloModulo ,
                                             short AV13OrderedBy ,
                                             bool AV14OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [ComandoModeloModulo], [ComandoFabricanteModulo], [ComandoNome], [ComandoId]";
         sFromString = " FROM [Comando]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV37Comandowwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([ComandoId] AS decimal(8,0))) like '%' + @lV37Comandowwds_1_filterfulltext) or ( [ComandoNome] like '%' + @lV37Comandowwds_1_filterfulltext) or ( 'gx_emptyitemtext' like '%' + LOWER(@lV37Comandowwds_1_filterfulltext) and ([ComandoFabricanteModulo] = '')) or ( 'maxtrack' like '%' + LOWER(@lV37Comandowwds_1_filterfulltext) and [ComandoFabricanteModulo] = 'Maxtrack') or ( 'gx_emptyitemtext' like '%' + LOWER(@lV37Comandowwds_1_filterfulltext) and ([ComandoModeloModulo] = '')) or ( 'mxt140' like '%' + LOWER(@lV37Comandowwds_1_filterfulltext) and [ComandoModeloModulo] = 'MXT140'))");
         }
         else
         {
            GXv_int5[0] = 1;
         ...
         {
            sOrderString += " ORDER BY [ComandoId]";
         }
         else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ComandoId] DESC";
         }
         else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY [ComandoNome]";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ComandoNome] DESC";
         }
         else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY [ComandoFabricanteModulo]";
         }
         else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ComandoFabricanteModulo] DESC";
         }
         else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY [ComandoModeloModulo]";
         }
         else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY [ComandoModeloModulo] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY [ComandoId]";
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM [Comando]";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV37Comandowwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( CONVERT( char(8), CAST([ComandoId] AS decimal(8,0))) like '%' + @lV37Comandowwds_1_filterfulltext) or ( [ComandoNome] like '%' + @lV37Comandowwds_1_filterfulltext) or ( 'gx_emptyitemtext' like '%' + LOWER(@lV37Comandowwds_1_filterfulltext) and ([ComandoFabricanteModulo] = '')) or ( 'maxtrack' like '%' + LOWER(@lV37Comandowwds_1_filterfulltext) and [ComandoFabricanteModulo] = 'Maxtrack') or ( 'gx_emptyitemtext' like '%' + LOWER(@lV37Comandowwds_1_filterfulltext) and ([ComandoModeloModulo] = '')) or ( 'mxt140' like '%' + LOWER(@lV37Comandowwds_1_filterfulltext) and [ComandoModeloModulo] = 'MXT140'))");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002V2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] );
               case 1 :
                     return conditional_H002V3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV37Comandowwds_1_filterfulltext",SqlDbType.VarChar,100,0} ,
          new Object[] {"@lV37Comandowwds_1_filterfulltext",SqlDbType.NVarChar,100,0} ,
          new Object[] {"@lV37Comandowwds_1_filterfulltext",SqlDbType.VarChar,100,0} ,
          new Object[] {"@lV37Comandowwds_1_filterfulltext",SqlDbType.VarChar,100,0} ,
          new Object[] {"@lV37Comandowwds_1_filterfulltext",SqlDbType.VarChar,100,0} ,
          new Object[] {"@lV37Comandowwds_1_filterfulltext",SqlDbType.VarChar,100,0} ,
