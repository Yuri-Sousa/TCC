...
namespace GeneXus.Programs {
   public class gamexamplelogin : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( "Iniciar sessão") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202142915174936", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         context.AddJavascriptSource("Shared/@genexus/web-controls-library/dist/gx-web-controls.js", "", false, true);
         context.AddJavascriptSource("AnimationView/web-animation-view/dist/bundle.js", "", false, true);
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormLogin\" data-gx-class=\"form-horizontal FormLogin\" novalidate action=\""+formatLink("gamexamplelogin.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "LOADER1_Loader", StringUtil.RTrim( Loader1_Loader));
         GxWebStd.gx_hidden_field( context, "LOADER1_Basecolor", StringUtil.LTrim( StringUtil.NToC( (decimal)(Loader1_Basecolor), 9, 0, ".", "")));
      }
      ...
      protected void WB080( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_9_082( true) ;
         }
         else
         {
            wb_table1_9_082( false) ;
         }
         return  ;
      }

      protected void wb_table1_9_082e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            ucLoader1.Render(context, "4rloader", Loader1_Internalname, "LOADER1Container");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUrl_Internalname, AV30URL, StringUtil.RTrim( context.localUtil.Format( AV30URL, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,108);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUrl_Jsonclick, 0, "Attribute", "", "", "", "", edtavUrl_Visible, 1, 0, "text", "", 0, "px", 1, "row", 2048, 0, 0, 0, 1, -1, 0, true, "GeneXusSecurityCommon\\GAMURL", "left", true, "", "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START082( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Iniciar sessão", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP080( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Loader1_Loader = cgiGet( "LOADER1_Loader");
            Loader1_Basecolor = (int)(context.localUtil.CToN( cgiGet( "LOADER1_Basecolor"), ",", "."));
      ...
      protected void E11082( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Headerrawhtml = "<link rel=\"shortcut icon\" type=\"image/x-icon\" href=\""+context.convertURL( (string)(context.GetImagePath( "aba53dd3-0c99-40af-aa60-035752cb316b", "", context.GetTheme( ))))+"\">";
         this.executeUsercontrolMethod("", false, "ANIMATIONLOGINContainer", "SetAnimation", "", new Object[] {(string)"AnimationLogin",(bool)true});
         this.executeUsercontrolMethod("", false, "ANIMATIONLOGINContainer", "Play", "", new Object[] {(short)0});
         ...
         tblTblespaco_Height = 100;
         AssignProp("", false, tblTblespaco_Internalname, "Height", StringUtil.LTrimStr( (decimal)(tblTblespaco_Height), 9, 0), true);
      ...
      protected void wb_table1_9_082( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWelcometitle_Internalname, "Olá!", "", "", lblWelcometitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleLogin", 0, "", 1, 1, 0, 0, "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_bitmap( context, imgLoginimage_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_24_082( true) ;
         }
         else
         {
            wb_table2_24_082( false) ;
         }
         return  ;
      }

      protected void wb_table2_24_082e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            /* User Defined Control */
            ucAnimationlogin.Render(context, "animationview", Animationlogin_Internalname, "ANIMATIONLOGINContainer");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavLogonto, cmbavLogonto_Internalname, StringUtil.RTrim( AV22LogOnTo), 1, cmbavLogonto_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", cmbavLogonto.Visible, cmbavLogonto.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeLoginImageLeft", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,45);\"", "", true, "HLP_GAMExampleLogin.htm");
            cmbavLogonto.CurrentValue = StringUtil.RTrim( AV22LogOnTo);
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, AV31UserName, StringUtil.RTrim( context.localUtil.Format( AV31UserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Email", edtavUsername_Jsonclick, 0, "AttributeLoginImageLeft", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, 0, 0, true, "GeneXusSecurityCommon\\GAMUserIdentification", "left", true, "", "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavUserpassword_Internalname, StringUtil.RTrim( AV32UserPassword), StringUtil.RTrim( context.localUtil.Format( AV32UserPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,53);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Senha", edtavUserpassword_Jsonclick, 0, "AttributeLoginImageLeft", "", "", "", "", 1, edtavUserpassword_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, -1, 0, 0, 1, 0, 0, true, "GeneXusSecurityCommon\\GAMPassword", "left", true, "", "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCellLogin CellPaddingLogin", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblForgotpassword_Internalname, "Esqueceu sua senha?", "", "", lblForgotpassword_Jsonclick, "'"+""+"'"+",false,"+"'"+"e19081_client"+"'", "", "DataDescriptionLogin", 7, "", 1, 1, 0, 1, "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "Iniciar sessão", bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCellLogin CellPaddingLogin", "left", "top", "", "", "div");
            wb_table3_70_082( true) ;
         }
         else
         {
            wb_table3_70_082( false) ;
         }
         return  ;
      }

      protected void wb_table3_70_082e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            wb_table4_78_082( true) ;
         }
         else
         {
            wb_table4_78_082( false) ;
         }
         return  ;
      }

      protected void wb_table4_78_082e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            ...
            wb_table1_9_082e( true) ;
         }
         else
         {
            wb_table1_9_082e( false) ;
         }
      }

      protected void wb_table4_78_082( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLoginwith_Internalname, "Ou começar com", "", "", lblLoginwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "DataDescriptionLogin", 0, "", 1, 1, 0, 1, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFacebook_Internalname, "<i class=\"fab fa-facebook-f GAMIconLogin\"></i>", "", "", lblFacebook_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOFACEBOOK\\'."+"'", "", "TextBlock", 5, "", lblFacebook_Visible, 1, 0, 1, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTwitter_Internalname, "<i class=\"fab fa-twitter GAMIconLogin\"></i>", "", "", lblTwitter_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOTWITTER\\'."+"'", "", "TextBlock", 5, "", lblTwitter_Visible, 1, 0, 1, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGoogle_Internalname, "<i class=\"fab fa-google GAMIconLogin\"></i>", "", "", lblGoogle_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOGOOGLE\\'."+"'", "", "TextBlock", 5, "", lblGoogle_Visible, 1, 0, 1, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRemote_Internalname, "<i class=\"fa fa-lock GAMIconLogin\"></i>", "", "", lblRemote_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOREMOTE\\'."+"'", "", "TextBlock", 5, "", lblRemote_Visible, 1, 0, 1, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_78_082e( true) ;
         }
         else
         {
            wb_table4_78_082e( false) ;
         }
      }

      protected void wb_table3_70_082( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoaccount_Internalname, "Não tem uma conta?", "", "", lblNoaccount_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRegisteruser_Internalname, "Criar uma agora", lblRegisteruser_Link, "", lblRegisteruser_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "DataDescriptionLogin", 0, "", 1, 1, 0, 0, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_70_082e( true) ;
         }
         else
         {
            wb_table3_70_082e( false) ;
         }
      }

      protected void wb_table2_24_082( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            sStyleString += " height: " + StringUtil.LTrimStr( (decimal)(tblTblespaco_Height), 10, 0) + "px" + ";";
            GxWebStd.gx_table_start( context, tblTblespaco_Internalname, tblTblespaco_Internalname, "", "", 0, "", "", 1, 2, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxtvazio_Internalname, " ", "", "", lblTxtvazio_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_24_082e( true) ;
         }
         else
         {
            wb_table2_24_082e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20214291518979", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplelogin.js", "?20214291518982", false, true);
         context.AddJavascriptSource("Shared/@genexus/web-controls-library/dist/gx-web-controls.js", "", false, true);
         context.AddJavascriptSource("AnimationView/web-animation-view/dist/bundle.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblTxtvazio_Internalname = "TXTVAZIO";
         tblTblespaco_Internalname = "TBLESPACO";
         Animationlogin_Internalname = "ANIMATIONLOGIN";
      ...
      public override void initialize_properties( )
      {
         ...
         Loader1_Basecolor = (int)(0x000000);
         Loader1_Loader = "2";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FORGOTPASSWORD.CLICK","{handler:'E19081',iparms:[{av:'AV19KeepMeLoggedIn',fld:'vKEEPMELOGGEDIN',pic:''},{av:'AV24RememberMe',fld:'vREMEMBERME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         StyleString = "";
         sImgUrl = "";
         ucAnimationlogin = new GXUserControl();
      ...
      private int tblTblespaco_Height ;
      ...
      private string tblTblespaco_Internalname ;
      ...
      private string Animationlogin_Internalname ;
      ...
      private string lblTxtvazio_Internalname ;
      private string lblTxtvazio_Jsonclick ;
      ...
      private GXUserControl ucAnimationlogin ;
