...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.AxisOrder" , Namespace="RastreamentoTCC" )]
	[Serializable]
	public class SdtQueryViewerElements_Element_AxisOrder : GxUserType
	{
		...
		public GxSimpleCollection<string> gxTpr_Values_GxSimpleCollection
		{
			...
			set {
				...
				gxTv_SdtQueryViewerElements_Element_AxisOrder_Values_N = 0;
		...
		{
			gxTv_SdtQueryViewerElements_Element_AxisOrder_Values_N = 1;
		...
		protected short gxTv_SdtQueryViewerElements_Element_AxisOrder_Values_N;
	...
	[DataContract(Name=@"QueryViewerElements.Element.AxisOrder", Namespace="RastreamentoTCC")]
