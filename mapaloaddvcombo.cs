...
namespace GeneXus.Programs {
   public class mapaloaddvcombo : GXProcedure
   {
      ...
      {
         get {
            return "mapa_Services_Execute" ;
         }

      }

      public mapaloaddvcombo( )
      {
      ...
      public mapaloaddvcombo( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP2_Combo_DataJson )
      {
         mapaloaddvcombo objmapaloaddvcombo;
         objmapaloaddvcombo = new mapaloaddvcombo();
         objmapaloaddvcombo.AV17ComboName = aP0_ComboName;
         objmapaloaddvcombo.AV12SearchTxt = aP1_SearchTxt;
         objmapaloaddvcombo.AV13Combo_DataJson = "" ;
         objmapaloaddvcombo.context.SetSubmitInitialConfig(context);
         objmapaloaddvcombo.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objmapaloaddvcombo);
         aP2_Combo_DataJson=this.AV13Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((mapaloaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV11MaxItems = 100;
         if ( StringUtil.StrCmp(AV17ComboName, "VeiculoIdPercurso") == 0 )
         {
            /* Execute user subroutine: 'LOADCOMBOITEMS_VEICULOIDPERCURSO' */
            S111 ();
            if ( returnInSub )
            {
               this.cleanup();
      ...
      protected void S111( )
      {
         /* 'LOADCOMBOITEMS_VEICULOIDPERCURSO' Routine */
         returnInSub = false;
         ...
         {
            A100VeiculoPlaca = P004F2_A100VeiculoPlaca[0];
            A105VeiculoGAMGUID = P004F2_A105VeiculoGAMGUID[0];
            A98VeiculoId = P004F2_A98VeiculoId[0];
      ...
      public override void initialize( )
      {
         ...
         A100VeiculoPlaca = "";
         A105VeiculoGAMGUID = "";
         P004F2_A100VeiculoPlaca = new string[] {""} ;
         P004F2_A105VeiculoGAMGUID = new string[] {""} ;
         P004F2_A98VeiculoId = new int[1] ;
         AV15Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV14Combo_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.mapaloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P004F2_A100VeiculoPlaca, P004F2_A105VeiculoGAMGUID, P004F2_A98VeiculoId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P004F2_A100VeiculoPlaca ;
      private string[] P004F2_A105VeiculoGAMGUID ;
      private int[] P004F2_A98VeiculoId ;
   ...
   public class mapaloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P004F2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P004F2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP004F2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
 ...
 [ServiceContract(Namespace = "GeneXus.Programs.mapaloaddvcombo_services")]
 [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Multiple)]
 [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
 public class mapaloaddvcombo_services : GxRestService
 {
    protected override bool IntegratedSecurityEnabled
    {
       get {
    ...
    [OperationContract(Name = "MapaLoadDVCombo" )]
                         ...
                         out string Combo_DataJson )
    {
       ...
       try
       {
          permissionPrefix = "mapa_Services_Execute";
          if ( ! IsAuthenticated() )
          {
             return  ;
          }
          if ( ! ProcessHeaders("mapaloaddvcombo") )
          {
             return  ;
          }
          mapaloaddvcombo worker = new mapaloaddvcombo(context);
