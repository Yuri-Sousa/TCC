...
namespace GeneXus.Programs.wwpbaseobjects {
   public class homeprogressbarcirclewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20214281546514", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.homeprogressbarcirclewc.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV5OptionTitle)),UrlEncode(StringUtil.LTrimStr(AV6Percentage,4,0))}, new string[] {"OptionTitle","Percentage"}) +"\">") ;
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            Ucpb_Percentage = (int)(context.localUtil.CToN( cgiGet( sPrefix+"UCPB_Percentage"), ",", "."));
            Ucpb_Circlewidth = (int)(context.localUtil.CToN( cgiGet( sPrefix+"UCPB_Circlewidth"), ",", "."));
            Ucpb_Circleprogresswidth = (int)(context.localUtil.CToN( cgiGet( sPrefix+"UCPB_Circleprogresswidth"), ",", "."));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20214281546569", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/homeprogressbarcirclewc.js", "?20214281546569", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/DVProgressIndicator/DVProgressIndicatorRender.js", "", false, true);
         }
