...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_masterpagetopactionswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202142815461073", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB310( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUserinformation_Internalname, 1, 0, "px", 0, "px", "ddoMenuUserInfo", "left", "top", " "+"data-gx-flex"+" ", "flex-direction:column;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "UserImageCell", "left", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, "", "User Image", "gx-form-item ReadonlyAttributeLabel", 0, true, "width: 25%;");
            /* Static Bitmap Variable */
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            AV5UserImage_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV5UserImage))&&String.IsNullOrEmpty(StringUtil.RTrim( AV15Userimage_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV5UserImage)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV5UserImage)) ? AV15Userimage_GXI : context.PathToRelativeUrl( AV5UserImage));
            ...
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "UserInfoNameCell", "left", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUsername_Internalname, "User Name", "gx-form-item UserInfoNameLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, AV6UserName, StringUtil.RTrim( context.localUtil.Format( AV6UserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsername_Jsonclick, 0, "UserInfoName", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, false, "", "left", true, "", "HLP_WWPBaseObjects\\WWP_MasterPageTopActionsWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E11312( )
      {
         ...
         AssignProp(sPrefix, false, imgavUserimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5UserImage)) ? AV15Userimage_GXI : context.convertURL( context.PathToRelativeUrl( AV5UserImage))), true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202142815461843", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wwp_masterpagetopactionswc.js", "?202142815461849", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         }
      ...
      public override void initialize_properties( )
      {
         ...
         Btnlogout_Caption = "Fechar sessão";
         ...
         Btnactionchangepassword_Caption = "Alterar sua senha";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOACTIONCHANGEPASSWORD'","{handler:'E12312',iparms:[]");
         setEventMetadata("'DOACTIONCHANGEPASSWORD'",",oparms:[]}");
         setEventMetadata("'DOLOGOUT'","{handler:'E13312',iparms:[]");
      ...
      private string AV15Userimage_GXI ;
