...
namespace GeneXus.Programs.wwpbaseobjects {
   public class masterpageframe : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm302( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?20214281557115", false, true);
      ...
      protected void WB300( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavPickerdummyvariable_Internalname, context.localUtil.Format(AV5PickerDummyVariable, "99/99/99"), context.localUtil.Format( AV5PickerDummyVariable, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", "", edtavPickerdummyvariable_Jsonclick, 0, "Invisible", "", "", "", "", 1, 1, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, false, "", "right", false, "", "HLP_WWPBaseObjects\\MasterPageFrame.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20214281557168", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?20214281557168", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         TempTags = "";
         AV5PickerDummyVariable = DateTime.MinValue;
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         sEvtType = "";
      ...
      private DateTime AV5PickerDummyVariable ;
