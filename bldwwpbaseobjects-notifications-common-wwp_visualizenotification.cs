...
using System.IO;
public class bldwwpbaseobjects_notifications_common_wwp_visualizenotification : GxBaseBuilder
{
   string cs_path = "." ;
   public bldwwpbaseobjects_notifications_common_wwp_visualizenotification( ) : base()
   {
   }
   ...
   {
      bldwwpbaseobjects_notifications_common_wwp_visualizenotification x = new bldwwpbaseobjects_notifications_common_wwp_visualizenotification() ;
      x.SetMainSourceFile( "wwpbaseobjects\\notifications\\common\\wwp_visualizenotification.cs");
